                    ...
                    <div className="flex flex-wrap -mx-6 lg:-mx-14">
                        <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 lg:mb-0">
                            <div className="relative flex items-center justify-center mb-10 w-20 h-20">
                                <Image className="absolute inset-0 w-full h-full" src="zospace-assets/lines/circle-chart.svg" alt="" />
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 lg:mb-0">
                            <div className="relative flex items-center justify-center mb-10 w-20 h-20">
                                <Image className="absolute inset-0 w-full h-full" src="zospace-assets/lines/circle-chart-purple.svg" alt="" />
                                <p className="text-2xl font-bold text-white">
                                    <span>45</span>
                                    <span className="text-base">%</span>
                                </p>
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14 mb-16 md:mb-0">
                            <div className="relative flex items-center justify-center mb-10 w-20 h-20">
                                <Image className="absolute inset-0 w-full h-full" src="zospace-assets/lines/circle-chart-green.svg" alt="" />
                                <p className="text-2xl font-bold text-white">
                                    <span>5</span>
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/4 px-6 lg:px-14">
                            <div className="relative flex items-center justify-center mb-10 w-20 h-20">
                                <Image className="absolute inset-0 w-full h-full" src="zospace-assets/lines/circle-chart-pink.svg" alt="" />
                                <p className="text-2xl font-bold text-white">
                                    <span>79</span>
                                    <span className="text-base">%</span>
                                </p>
