                    ...
                    <div className="max-w-4xl mx-auto">
                            ...
                            <div className="w-full lg:w-1/3 px-4 mb-4 lg:mb-0" data-aos="fade-right">
                                <div className="bg-gray-600 rounded-lg">
                                    ...
                                    <div className="px-14 py-8">
                                        ...
                                        <div className="md:text-right"><a className="inline-block px-12 py-4 border border-gray-300 hover:border-gray-200 rounded-full font-bold text-white" href="/">Message</a></div>
                                    </div>
                                </div>
                            </div>
                            <div className="w-full lg:w-2/3 px-4">
                                <div className="py-6 px-8 mb-4 bg-gray-600 rounded-lg" data-aos="fade-left">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-lg font-bold text-white">+6289699728900</p>
                                    </div>
                                </div>
                                <div className="py-6 px-8 mb-10 bg-gray-600 rounded-lg" data-aos="fade-left" data-aos-delay="100">
                                    <div className="flex items-center">
                                        <span className="flex items-center justify-center w-12 h-12 mr-8 bg-blue-500 rounded-lg">
                                        ...
                                        <p className="text-lg font-bold text-white">ppabimanyu@gmail.com</p>
                                    </div>
                                </div>
                                <div className="py-6 px-8" data-aos="fade-left" data-aos-delay="200">
                                    <div className="flex">
                                        ...
                                        <div>
                                            <div className="pb-4 pr-16 mb-6 border-b border-gray-500">
                                                <p className="text-lg font-bold text-white">Ambulu, Jember</p>
                                                <p className="text-lg font-bold text-white">East Java, Indonesia</p>
                                            </div>
                        ...
                        {/* <div className="text-center">
                            ...
                            <a className="inline-flex text-blue-400 hover:text-blue-500 font-bold" href="/">
                                ...
                                <svg className="ml-4 w-4 h-5" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
